...
def _find_server_binary() -> str | None:
    ...
    4. PATH
    5. Download from GitHub releases (v0.44.1 prebuilt Linux x64)
    """
    candidates = [
    ...
    url = "https://github.com/visorcraft/MongrelDB/releases/download/v0.44.1/mongreldb-server-linux-x64"
    try:
